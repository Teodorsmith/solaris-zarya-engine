...
- `agent/engine/chat.py`: Multi-turn conversational Chat Engine as the default REPL fallback.
- `agent/cli.py` & `agent/main.py`: Interactive CLI shell supporting `ask`, `correct`, `forget`, `--demo`, and conversational chat.
